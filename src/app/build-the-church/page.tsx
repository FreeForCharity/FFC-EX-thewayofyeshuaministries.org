  ...
  return (
    <CausePage
      ...
      body={
        <>
          <p>
            <em>“Unless the Lord builds the house, those who build it labor in vain.”</em> — Psalm
            127:1
          </p>
          <p>
            ...
            permanent home — a building of our own where our community can come together for
          ...
          <ul>
            ...
            <li>
              ...
              programs — somewhere to receive, sort, and prepare what we send out
            </li>
            <li>
          ...
          <p>
            Every contribution — large or small — brings this closer. Building funds go toward land,
            construction, utilities, and the practical work of preparing a place that will outlast
            any one of us and serve generations to come.
          </p>
          <p>
            <em>
