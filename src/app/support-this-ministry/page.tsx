    ...
    <CausePage
      ...
      body={
        <>
          ...
          <ul>
            <li>
              <strong>Prison Outreach</strong> &mdash; communion supplies, Holy Day packages, and
              Scripture sent to incarcerated brothers and sisters
            </li>
            <li>
              <strong>Build the Church</strong> &mdash; a permanent home for worship, study, and
              fellowship
            </li>
            <li>
              <strong>Sponsor a Tiny Home</strong> &mdash; dignified housing for neighbors in need
            </li>
            <li>
              <strong>Automobile Program</strong> &mdash; donated and repaired vehicles for families
              who need transportation
            </li>
            <li>
              <strong>Teaching ministry</strong> &mdash; videos, podcasts, blog posts, and
              fellowship gatherings that point people to Yeshua
            </li>
          </ul>
          <p>
            <em>
