...
export const metadata: Metadata = {
  title: 'Terms of Service | The Way of Yeshua Ministries',
  description: 'Terms of Service for The Way of Yeshua Ministries website',
}
      ...
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div id="aria-font">
          ...
          <h1 className="text-[30px] text-[#333] pb-[10px] leading-[1em] font-[500]">
            The Way of Yeshua Ministries Terms of Service
          </h1>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Welcome to The Way of Yeshua Ministries! These Terms of Service (“Terms”) govern your
            access to and use of our website, services, and platforms (collectively, “Services”),
            provided by Free For Charity (“we,” “us,” or “our”). By accessing or using our Services,
          ...
          <ul className="list-inside ml-[1.5em] space-y-[4px]">
            ...
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
              Using the Services to solicit funds outside the scope of The Way of Yeshua
              Ministries’s mission.
            </li>
          </ul>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All donations made to The Way of Yeshua Ministries are voluntary and non-refundable. By
            making a donation, you agree to our Donation Policy, which is incorporated by reference
            into these Terms.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All payments made to The Way of Yeshua Ministries are voluntary and non-refundable. No
            refunds will be given due to the nonprofit nature of The Way of Yeshua Ministries.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            are the property of The Way of Yeshua Ministries or its licensors. You agree not to use,
            reproduce, distribute, or create derivative works based on our intellectual property
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            controlled by The Way of Yeshua Ministries. We are not responsible for the content,
            privacy policies, or practices of any third-party websites or services. You acknowledge
            and agree that The Way of Yeshua Ministries shall not be liable for any damages or loss
            caused by or in connection with your use of any third-party websites or services.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Our Services are provided on an “as is” and “as available” basis. The Way of Yeshua
            Ministries makes no representations or warranties of any kind, express or implied,
            regarding the use or the results of our Services in terms of accuracy, reliability, or
            otherwise. Free For Charity disclaims all warranties, express or implied, including, but
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            To the fullest extent permitted by law, The Way of Yeshua Ministries shall not be liable
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            You agree to indemnify, defend, and hold harmless The Way of Yeshua Ministries, its
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Thank you for supporting The Way of Yeshua Ministries and for complying with these Terms
            of Service.
          </p>
        </div>
      </div>
